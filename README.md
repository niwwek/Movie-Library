...
[main.py](https://github.com/user-attachments/files/27034907/main.py)
[movies.json](https://github.com/user-attachments/files/27034908/movies.json)import tkinter as tk
...
# Функции добавления, фильтрации, сохранения, загрузки
...
genre_filter_btn = tk.Button(filter_frame, text="Фильтр", command=filter_by_genre)
genre_filter_btn.grid(row=0, column=2)
...
year_filter_btn = tk.Button(filter_frame, text="Фильтр", command=filter_by_year)
year_filter_btn.grid(row=1, column=2)
